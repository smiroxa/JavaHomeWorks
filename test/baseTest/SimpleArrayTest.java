...
public class SimpleArrayTest {
    ...
    {
        int[] result = SimpleArray.selectionSort(new int[]{0, 0, 2, 10, 5, 4, 8, 1, 0, 7, 9, 0, 11, 12, 0, 14, 15});
        assertTrue(Arrays.equals(result, new int[]{0, 0, 0, 0, 0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 12, 14, 15}));
    }
    @Test
    ...
    {
        {
            int[] result = SimpleArray.insertionSort(new int[]{0, 0, 2, 10, 5, 4, 8, 1, 0, 7, 9, 0, 11, 12, 0, 14, 15});
            assertTrue(Arrays.equals(result, new int[]{0, 0, 0, 0, 0, 1, 2, 4, 5, 7, 8, 9, 10, 11, 12, 14, 15}));
        }
    }
}
